...
type
  TAdrockFilterComboBoxCustom = class(TFilterComboBox)
  ...
  TAdrockFilterComboBox = class(TAdrockFilterComboBoxCustom)
  published
    { Published declarations }
...
Constructor TAdrockFilterComboBoxCustom.Create(Aowner : TComponent);
begin
...
Destructor TAdrockFilterComboBoxCustom.Destroy;
begin
  fWhenFocused.Free;
  fWhenFocused := NIL;
  Inherited Destroy;
...
Procedure TAdrockFilterComboBoxCustom.Loaded;
begin
  inherited Loaded;
end;

Procedure TAdrockFilterComboBoxCustom.CMEnter(Var Message : TCMEnter);
begin
  Inherited;
  fWhenFocused.OnEnter;
end;

Procedure TAdrockFilterComboBoxCustom.CMExit(Var Message : TCMExit);
begin
  fWhenFocused.OnExit;
  Inherited;
end;

Procedure TAdrockFilterComboBoxCustom.BeforeChange(Sender : TObject);
begin
  if (Assigned(fOnBeforeChange)) then
    fOnBeforeChange(Sender);
end;

Procedure TAdrockFilterComboBoxCustom.BeforeDataChange(Sender : TObject);
begin
  if (Assigned(fOnBeforeDataChange)) then
    fOnBeforeDataChange(Sender);
end;

Procedure TAdrockFilterComboBoxCustom.CustomOnEnterWhenFocusedHandle(Sender : TObject; fOwner : TObject;
...
Procedure TAdrockFilterComboBoxCustom.CustomOnExitWhenFocusedHandle(Sender : TObject; fOwner : TObject;
  fSavedBackColor : TColor);
begin
  Color := fSavedBackColor;
end;

procedure TAdrockFilterComboBoxCustom.Notification(AComponent: TComponent;  Operation: TOperation);
begin
